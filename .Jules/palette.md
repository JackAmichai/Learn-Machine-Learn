...
**Learning:** Icon-only toggle buttons (like ) using dynamic s ('☀️'/'🌙' or 'Toggle Theme') can be confusing. Screen readers announce the label change but not the state.
**Action:** Use a static  describing the feature (e.g., 'Dark Theme') and a dynamic  attribute to properly communicate the active/inactive state to screen readers.
## 2025-02-12 - Theme Toggle Accessibility
