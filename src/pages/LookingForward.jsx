              ...
              {FUTURE_LESSONS.map(lesson => {
                ...
                return (
                  <div key={lesson.id} className={`lesson-card ${isComplete ? 'complete' : ''}`}>
                    ...
                    <div className="lesson-content" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(lesson.content, { USE_PROFILES: { mathMl: true, svg: true } }) }} />
                    
                    {lesson.solved && (
                      <div className="lesson-section solved-section">
                        <h4>✅ What This Solved</h4>
                        <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(lesson.solved, { USE_PROFILES: { mathMl: true, svg: true } }) }} />
                      </div>
                    )}
                    ...
                    {lesson.shortcomings && (
                      <div className="lesson-section shortcomings-section">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(lesson.shortcomings, { USE_PROFILES: { mathMl: true, svg: true } }) }} />
                      </div>
                    )}
