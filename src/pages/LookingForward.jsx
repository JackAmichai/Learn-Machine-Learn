              ...
              {FUTURE_LESSONS.map(lesson => {
                ...
                return (
                  <div key={lesson.id} className={`lesson-card ${isComplete ? 'complete' : ''}`}>
                    ...
                    {/* 🛡️ Sentinel: Sanitize HTML content to prevent Cross-Site Scripting (XSS) */}
                    <div className="lesson-content" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(lesson.content) }} />
