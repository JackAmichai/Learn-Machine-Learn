...
export function MathModal({ topic, onClose, onComplete }) {
 ...
 <>
 <div className={`math-body ${!presentation.showMath ? 'visual-only' : ''}`} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(data.content, { USE_PROFILES: { html: true, mathMl: true, svg: true } }) }} /> {/* Security: Sanitize HTML to prevent XSS */}
  ...
  <div className="lesson-section solved-section">
    ...
    <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(data.solved, { USE_PROFILES: { html: true, mathMl: true, svg: true } }) }} /> {/* Security: Sanitize HTML to prevent XSS */}
  </div>
  )}
  ...
  <div className="lesson-section shortcomings-section">
    ...
    <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(data.shortcomings, { USE_PROFILES: { html: true, mathMl: true, svg: true } }) }} /> {/* Security: Sanitize HTML to prevent XSS */}
  </div>
  )}
