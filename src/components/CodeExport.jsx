        ...
        <div className="code-modal-overlay">
            <div className="code-modal">
                ...
                <div className="lang-tabs">
                    <button className={lang === 'python' ? 'active' : ''} onClick={() => setLang('python')} aria-pressed={lang === 'python'}>Python (Keras)</button>
                    <button className={lang === 'js' ? 'active' : ''} onClick={() => setLang('js')} aria-pressed={lang === 'js'}>JavaScript (TF.js)</button>
                </div>
