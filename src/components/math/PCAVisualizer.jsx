...
export default function PCAVisualizer({ values = {} }) {
  ...
  useEffect(() => {
    setTimeout(() => { if (values.lambda1 !== undefined) setComponent1(values.lambda1); }, 0);
    setTimeout(() => { if (values.lambda2 !== undefined) setComponent2(values.lambda2); }, 0);
    setTimeout(() => { if (values.lambda3 !== undefined) setComponent3(values.lambda3); }, 0);
