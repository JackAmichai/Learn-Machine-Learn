...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        async function draw() {
            ...
            try {
                // ⚡ Bolt: Removed tf.tidy() and dataSync() to avoid blocking the main thread.
                // Using async .data() with manual memory management in a try/finally block instead.
