...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        // Optimization: Use asynchronous data extraction to prevent blocking
        // the main UI thread during predictions, improving overall responsiveness.
        async function draw() {
