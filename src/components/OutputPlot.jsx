...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        let isStale = false; // Cancellation token to prevent race conditions
        ...
        async function drawPlot() {
            ...
            try {
                ...
                // ⚡ Bolt Performance Optimization: Replace blocking dataSync() with async data()
                // This prevents the main UI thread from freezing during tensor downloads,
                // keeping the application smooth during training.
                ...
                // Manually manage memory since tf.tidy does not support promises
