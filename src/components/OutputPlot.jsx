    ...
    useEffect(() => {
        ...
        const renderPlot = async () => {
            try {
                ...
                // ⚡ Bolt Optimization: Replace synchronous dataSync() with async data()
                // This prevents blocking the main UI thread during expensive tensor
                // operations. Expected impact: significantly smoother UI rendering and
                // animations during active training phases.
