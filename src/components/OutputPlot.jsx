    ...
    useEffect(() => {
        ...
        async function drawPlot() {
            ...
            try {
                ...
                // Bolt: Use async data extraction to avoid blocking main thread
                ...
                // Bolt: manually dispose tensors created outside of tf.tidy()
                const tensorsToDispose = [];
                if (inputTensor) tensorsToDispose.push(inputTensor);
                if (predsTensor) tensorsToDispose.push(predsTensor);
