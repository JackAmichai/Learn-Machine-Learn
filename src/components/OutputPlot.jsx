...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        // Optimization: Replaced synchronous dataSync() with async await data()
        // Expected impact: Prevents main-thread blocking during model predictions,
        // resulting in smoother UI updates and eliminating visual stutter during training.
