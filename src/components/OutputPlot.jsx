...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                // Optimization: Use asynchronous `data()` instead of synchronous `dataSync()`
                // to prevent blocking the main UI thread during predictions.
                // We manually manage tensor memory since `tf.tidy()` doesn't support async operations.
