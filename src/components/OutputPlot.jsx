    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                ...
                if (predsTensor) {
                    // Optimization: Use asynchronous extraction instead of synchronous dataSync()
                    // to prevent blocking the main UI thread during renders.
