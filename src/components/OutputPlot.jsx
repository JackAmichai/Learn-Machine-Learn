...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        // ⚡ Bolt Optimization: Use async data extraction (predsTensor.data())
        // instead of dataSync() to prevent blocking the main UI thread during
        // high-frequency re-renders. Reduces jank and improves rendering fps.
