...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        const renderPlot = async () => {
            ...
            // ⚡ Bolt: Convert synchronous tf.tidy() and dataSync() to async execution to avoid blocking the main UI thread. Use try/finally for explicit memory management and check for stale effects before rendering.
            let inputTensor;
            let predsTensor;
            let preds;
