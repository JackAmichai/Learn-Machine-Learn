    ...
    useEffect(() => {
        ...
        async function drawPlot() {
            ...
            try {
                ...
                // Changed from synchronous `dataSync()` to asynchronous `data()`.
                // `dataSync()` blocks the main UI thread while fetching predictions from the GPU,
                // causing severe UI jank during training. By awaiting `data()`, the main thread
                // remains responsive to user input and animations while the GPU processes.
                ...
                console.error("Error drawing output plot:", error);
            } finally {
                // Ensure memory is always cleaned up, even if the async call rejects
                if (predTensor) {
