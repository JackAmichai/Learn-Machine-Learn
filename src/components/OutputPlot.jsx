    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                ...
                // ⚡ Bolt: Replaced synchronous dataSync() with async data() to prevent blocking the main thread
                ...
                // ⚡ Bolt: Explicitly manage memory by disposing tensors since tf.tidy does not support promises
