    ...
    useEffect(() => {
        ...
        async function drawPlot() {
            ...
            try {
                ...
                // ⚡ Bolt: Replace synchronous dataSync() with async data() to prevent main thread blocking
        ...
        return () => {
            isStale = true; // ⚡ Bolt: properly cancel effect execution if component unmounts
        };
