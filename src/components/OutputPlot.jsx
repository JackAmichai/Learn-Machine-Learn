    ...
    useEffect(() => {
        ...
        async function drawOutput() {
            ...
            try {
                ...
                // ⚡ Bolt: Use async data() to prevent blocking the main UI thread during renders
                const preds = await predsTensor.data();

                if (isStale) return; // ⚡ Bolt: Prevent race conditions from stale renders
                ...
                // ⚡ Bolt: Manually dispose tensors since tf.tidy() doesn't support async operations
