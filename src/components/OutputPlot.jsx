    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                ...
                // ⚡ Bolt Optimization: Replacing synchronous .dataSync() with asynchronous .data()
                // Impact: Prevents blocking the main thread during GPU->CPU transfer, eliminating UI freezes
                // Measurement: Renders feel immediate and no longer drop 60fps frames during rapid model updates
                ...
                console.error("Error rendering output plot", error);
            } finally {
