    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                ...
                // ⚡ Bolt: Using async data() instead of synchronous dataSync() to prevent blocking the main thread
                ...
                // ⚡ Bolt: Manually dispose tensors since tf.tidy() does not support promises
