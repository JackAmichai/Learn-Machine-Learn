    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                ...
                // Replaced synchronous dataSync() with async data() to prevent blocking the main UI thread while fetching GPU memory.
                const preds = await predsTensor.data();

                if (!isMounted) return;

                // Clear canvas before drawing to prevent opacity buildup
