    ...
    useEffect(() => {
        ...
        const draw = async () => {
            ...
            try {
                ...
                // ⚡ BOLT OPTIMIZATION: Replaced synchronous tf.Tensor.dataSync() with asynchronous
                // await tf.Tensor.data() to extract grid predictions.
                // IMPACT: Eliminates main UI thread blocking during continuous render loops,
                // preventing UI freezing and ensuring smooth 60fps frame rates while models train.
            ...
            for (let i = 0; i < gridSize; i++) {
                for (let j = 0; j < gridSize; j++) {
                    const val = predsArray[i * gridSize + j];
