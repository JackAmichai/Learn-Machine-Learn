...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        // ⚡ Bolt Optimization: Switched from synchronous dataSync() (which blocks the main thread)
        // to asynchronous .data() within an async function to keep the UI responsive during prediction.
