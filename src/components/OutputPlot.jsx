    ...
    useEffect(() => {
        ...
        const drawPlot = async () => {
            try {
                ...
                // ⚡ Bolt: Replace blocking dataSync() with async await .data() to prevent main thread freeze
                ...
                // Manually dispose tensors to prevent memory leaks since tf.tidy doesn't support async
