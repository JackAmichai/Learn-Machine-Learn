...
export function OutputPlot({ model, data, modelVersion }) {
    ...
    useEffect(() => {
        ...
        // ⚡ Bolt Optimization: Migrated from synchronous dataSync() to async data()
        // Why: dataSync() blocks the main UI thread waiting for GPU/CPU tensor resolution.
        // Impact: Prevents UI freezing during high-frequency prediction renders (e.g., training loops), improving FPS.
        let isActive = true;
