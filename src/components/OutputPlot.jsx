    ...
    useEffect(() => {
        ...
        async function renderPlot() {
            ...
            try {
                ...
                // Bolt: Used await .data() instead of .dataSync() to prevent blocking main UI thread
                const preds = await predsTensor.data();
                if (!isMounted) return;

                // Clear canvas before drawing new frame to prevent accumulation and flickering during async rendering
