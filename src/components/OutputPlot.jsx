    ...
    useEffect(() => {
        ...
        const renderPlot = async () => {
            ...
            try {
                ...
                // ⚡ Bolt: Using async .data() instead of blocking .dataSync() to prevent main thread freeze
                ...
                // ⚡ Bolt: explicitly clean up tensors since tf.tidy doesn't support async operations
