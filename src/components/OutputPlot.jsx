    ...
    useEffect(() => {
        ...
        async function drawPlot() {
            ...
            try {
                ...
                // ⚡ Bolt: Replace blocking dataSync() with async await tensor.data()
                const preds = await predsTensor.data();

                if (!isMounted) return;

                // Clear canvas to prevent opacity buildup from previous frames after async await
                ...
                // Manual cleanup since tf.tidy doesn't support async/Promises
