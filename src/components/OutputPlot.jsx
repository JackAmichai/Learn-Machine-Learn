    ...
    useEffect(() => {
        ...
        async function drawPlot() {
            ...
            try {
                ...
                // ⚡ Bolt: Replacing synchronous dataSync with async tensor.data()
                // to prevent blocking the UI thread during plot rendering.
                ...
                // Manually dispose tensors since tf.tidy cannot wrap async operations
                if (inputTensor) tf.dispose(inputTensor);
                if (predsTensor) tf.dispose(predsTensor);
            }
        }
