...
export function WeightHeatmap({ model, modelVersion, structure }) {
    ...
    // Fetch weights asynchronously to avoid blocking UI thread
    useEffect(() => {
        let isMounted = true;
