...
export function Controls(props) {
    ...
    const handleImportFile = (event) => {
        ...
        // Security enhancement: Prevent client-side DoS by enforcing a strict file size limit (5MB)
        if (file.size > 5 * 1024 * 1024) {
            setStatus('error', 'File exceeds 5MB limit. Please upload a smaller model file.');
