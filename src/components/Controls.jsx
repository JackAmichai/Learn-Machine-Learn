...
export function Controls(props) {
    ...
    const handleSaveLocal = () => {
        try {
            ...
            pushToast({ type: 'success', title: 'Saved', message: `Saved to browser storage ${stamp ? `@ ${stamp}` : ''}`.trim() });
        } catch (err) {
    ...
    const handleLoadLocal = () => {
        try {
            ...
            if (!snapshot) {
                pushToast({ type: 'info', title: 'Not Found', message: 'No saved model found in this browser yet.' });
                return;
            }
            pushToast({ type: 'success', title: 'Restored', message: 'Model restored from browser storage.' });
        } catch (err) {
        ...
        <div className="controls-panel">
            ...
            <div className="section">
                <div className="p-header">
                    <h3>Architecture</h3>
                    <button className="btn-sm" onClick={addLayer} aria-label="Add a hidden layer">+ Layer</button>
                </div>
