                        ...
                        <div className="section">
                            ...
                            {trainingMode === 'slow' && (
                                <div className="slow-slider">
                                    <label htmlFor="hp-frame-delay">Frame Delay</label>
                                    <input id="hp-frame-delay" type="range" min="150" max="2000" step="50" value={slowDelay} onChange={(e) => setSlowDelay(parseInt(e.target.value, 10))} />
                        ...
                        {mode === 'simple' && (
                            <div className="section">
                                ...
                                <div className="noise-control">
                                    <label htmlFor="hp-noise">Noise</label>
                                    <input id="hp-noise" type="range" min="0" max="0.6" step="0.01" value={datasetParams.noise} onChange={(e) => handleNoiseChange(parseFloat(e.target.value))} />
                    ...
                    <>
                        <div className="section">
                            ...
                            <div className="hp-grid">
                                <label htmlFor="hp-learning-rate"><Tooltip word="Learning Rate" /></label>
                                <div className="lr-control">
                                    <input id="hp-learning-rate" type="range" min="0.001" max="0.3" step="0.001" value={hyperparams.learningRate} onChange={(e) => updateHyperparams({ learningRate: parseFloat(e.target.value) })} />
                                    <span>{hyperparams.learningRate}</span>
                                </div>

                                <label htmlFor="hp-activation"><Tooltip word="Activation" /></label>
                                <select id="hp-activation" value={hyperparams.activation} onChange={(e) => updateHyperparams({ activation: e.target.value })}>
                                ...
                                <select id="hp-optimizer" value={hyperparams.optimizer} onChange={(e) => updateHyperparams({ optimizer: e.target.value })}>
                                ...
                                <div className="lr-control">
                                    <input id="hp-batch-size" type="range" min="1" max="128" step="1" value={hyperparams.batchSize || 32} onChange={(e) => updateHyperparams({ batchSize: parseInt(e.target.value, 10) })} />
                        ...
                        <div className="section">
                            ...
                            <div className="clip-control">
                                <label htmlFor="hp-gradient-clip">Gradient Clip</label>
                                <input id="hp-gradient-clip" type="range" min="0" max="5" step="0.1" value={hyperparams.gradientClip} onChange={(e) => updateHyperparams({ gradientClip: parseFloat(e.target.value) })} />
